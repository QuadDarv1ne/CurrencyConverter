...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background-color: #6592fc") # синий цвет
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(160, 80, 191, 171))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("exchanging.png"))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.frame)
        self.label_2.setGeometry(QtCore.QRect(120, 20, 331, 51))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
